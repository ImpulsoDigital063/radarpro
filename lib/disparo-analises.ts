...
minha porta tá aberta quando fizer sentido, doutor`,
  ...
  24: {
    ...
    abertura: `Vi que você tem 120 avaliações no Google e nota 5 — em advocacia, isso é raro
...
quando ele chega no Maps e vê só endereço, ele liga em você ou no concorrente?`,
    followup_d3: `uma coisa que vejo aqui em Palmas
...
se fizer sentido depois, me chama`,
  ...
  146: {
    ...
    abertura: `Vi que vocês têm 109 avaliações 5 estrelas em perfumaria importada aí em Palmas
cliente novo que vai gastar R$500 num importado pesquisa MUITO antes — desconfia de quem só tem Insta
hoje quem busca isso te acha ou cai em loja online de SP?`,
    followup_d3: `uma coisa que vejo em perfumaria importada
cliente que paga R$500 quer ver foto da loja, política de troca, autenticidade — Insta não cobre isso. tá rolando aí?`,
    followup_d7: `vou parar por aqui pra não encher
se fizer sentido depois, me chama`,
    pre_engajamento_ig: PRE_IG_PADRAO,
  ...
  116: {
    ...
    abertura: `Vi que tu trabalha com moda executiva feminina aí em Palmas — nicho posicionado, 5 estrelas com 63 avaliações
advogada/servidora que acabou de chegar em Palmas pesquisa "moda executiva Palmas" antes de comprar
hoje quem busca isso te acha ou cai em loja online de SP?`,
    followup_d3: `uma coisa que vejo em moda executiva
...
se fizer sentido depois, me chama`,
  ...
  9: {
    ...
    abertura: `Vi que tu tem 5 estrelas com 63 avaliações como nutricionista em Palmas
mas Insta capta quem já te segue — quem pesquisa "nutricionista Palmas" no Google às 23h cai em nutri qualquer
quanto desse paciente novo tu acha que perde por mês?`,
    followup_d3: `uma coisa que vejo em nutri autônoma
...
se fizer sentido depois, me chama`,
  ...
  11: {
    ...
    abertura: `Vi que você é nutri nefro em Palmas — nicho raríssimo na cidade
...
quando ele busca isso, te acha ou perde pelo caminho?`,
    followup_d3: `uma coisa que vejo em nicho médico raro
...
se fizer sentido depois, me chama`,
  ...
  1093: {
    ...
    abertura: `Vi que tu tem story FIXO "Shop On-line" no perfil há um tempo
isso mostra que tu já reconheceu que precisa de loja online — só travou em algum ponto
em qual ponto tu travou: preço, complexidade ou esperando alguém pra fazer?`,
    followup_d3: `uma coisa que vejo em loja com base pronta
447 posts e 2.7% de engajamento é tração real — o que falta é só o canal. tá rolando isso contigo?`,
    followup_d7: `vou parar por aqui pra não encher
se fizer sentido depois, me chama`,
    pre_engajamento_ig: PRE_IG_PADRAO,
  ...
  1087: {
    ...
    abertura: `Vi que vocês têm 2.140 posts no Insta — 5+ anos de catálogo acumulado em moda feminina
...
como ela acha hoje a peça que ela quer?`,
    followup_d3: `uma coisa que vejo em loja com volume alto
...
se fizer sentido depois, me chama`,
  ...
  1092: {
    ...
    abertura: `Vi que vocês parcelam 3x cartão via direct — print do cartão, conferência manual, maquininha
isso é uns 15-20 minutos de operação por cada venda parcelada
quanto cliente nova trava em "mando dado de cartão por DM mesmo?" e some?`,
    followup_d3: `uma coisa que vejo em loja que parcela via DM
cliente nova não confia em mandar cartão por mensagem — ela some sem avisar. tá rolando isso contigo?`,
    followup_d7: `vou parar por aqui pra não encher
se fizer sentido depois, me chama`,
    pre_engajamento_ig: PRE_IG_PADRAO,
  ...
  1089: {
    ...
    abertura: `Vi que tu posta preço e parcelamento direto no caption ("3x R$146 ou 6x R$73"), bio diz "enviamos pra todo Brasil"
basicamente tu já fez metade do trabalho de uma loja online — só falta o botão de comprar
quanta cliente lê caption mas trava em "mandar DM pra fechar" e some?`,
    followup_d3: `uma coisa que vejo em loja que vende por caption
quando cliente já lê preço pronto mas precisa mandar DM, perde 30-50% no caminho. tá rolando contigo?`,
    followup_d7: `vou parar por aqui pra não encher
se fizer sentido depois, me chama`,
    pre_engajamento_ig: PRE_IG_PADRAO,
  ...
  1103: {
    ...
    abertura: `Vi que tu tem 16 anos de curadoria em semijoia premium em Palmas
mas atendimento é 100% local seg-sex 9h30-18h30 — cliente de Goiânia, Brasília que viu peça tua no story não consegue comprar
quanto dessa cliente de fora tu acha que perde por mês?`,
    followup_d3: `uma coisa que vejo em marca premium consolidada
...
se fizer sentido depois, me chama`,
  ...
  1102: {
    ...
    abertura: `Vi que vocês têm 5 lojas físicas + envio Brasil declarado + verificação Insta
...
quantos desistem nesse caminho?`,
    followup_d3: `uma coisa que vejo em operação multi-loja
...
se fizer sentido depois, me chama`,
  ...
  1104: {
    ...
    abertura: `Vi que vocês são a única perfumaria importada de luxo do Capim Dourado em Palmas
cliente que mora em Goiânia, Imperatriz, Brasília e quer importado ORIGINAL — esse hoje vai pra Sephora ou Beleza na Web
quanto desse cliente de fora vocês perdem por mês?`,
    followup_d3: `uma coisa que vejo em perfumaria importada
cliente que vai gastar R$800 num importado não compra de Insta sem CNPJ — pesquisa NF-e e selo de autenticidade. tá rolando aí?`,
    followup_d7: `vou parar por aqui pra não encher
se fizer sentido depois, me chama`,
  ...
  1108: {
    ...
    abertura: `Vi que tu atende ozonioterapia, soroterapia e injetáveis em Palmas
...
hoje quem busca isso te acha ou cai no concorrente?`,
    followup_d3: `uma coisa que vejo direto em estética
quem cobra R$200-400 por sessão sem site profissional perde muito cliente que ia gastar — tá rolando isso contigo?`,
    followup_d7: `vou parar por aqui pra não encher
se fizer sentido depois, me chama`,
  ...
  1109: {
    ...
    abertura: `Vi que você é endocrinologista CRM-TO 8510 com RQE — autoridade técnica visível
...
se fizer sentido depois, me chama`,
  ...
  1110: {
    ...
    abertura: `Vi que você é endocrinologista CRM-TO 4746 com RQE dupla, postou ontem sobre Tirzepatida
mas o link da bio (contate.me) é genérico — paciente que pesquisa "Tirzepatida Palmas" cai num "AGENDAR" sem contexto
quanto desse paciente novo perde por mês?`,
    followup_d3: `uma coisa que vejo em endocrino com conteúdo técnico ativo
...
se fizer sentido depois, me chama`,
  ...
  1111: {
    ...
    abertura: `Vi que você é nutróloga atendendo Palmas + Goiânia
o linktr.ee mistura as duas agendas — paciente palmense que pesquisa "nutróloga Palmas" tem que adivinhar qual link é dele
quanto desse paciente novo de Palmas perde por mês?`,
    followup_d3: `uma coisa que vejo em médico cross-cidade
...
se fizer sentido depois, me chama`,
  ...
  1107: {
    ...
    abertura: `Vi que vocês têm 14 anos de móveis autorais e domínio mobiliaremoveis.com.br
mas o site é só apresentação — cliente que vai gastar R$8.000 numa mesa não vê catálogo, preço, orçamento online
quanto desse cliente premium some pelo caminho do "ah, vou ter que conversar"?`,
    followup_d3: `uma coisa que vejo em móveis sob medida
ticket alto exige cliente chegar qualificado — site institucional não filtra, e DM trava no preço. tá rolando aí?`,
    followup_d7: `vou parar por aqui pra não encher
se fizer sentido depois, me chama`,
  ...
  1113: {
    ...
    abertura: `Vi que vocês têm presença ativa em Insta E TikTok — único de moda masculina em Palmas que vi com isso
mas tanto Insta quanto TikTok terminam num wa.me — cliente que assiste live tem que mandar DM pra fechar
quanto cliente da live some no caminho da DM?`,
    followup_d3: `uma coisa que vejo em moda masculina jovem
tu já tem o ativo mais raro (conteúdo TikTok ativo) — só falta canal de venda integrado. tá rolando esse buraco contigo?`,
    followup_d7: `vou parar por aqui pra não encher
se fizer sentido depois, me chama`,
  ...
  1118: {
    ...
    abertura: `Vi que você trabalha com faceta e harmonização aí em Palmas
mas a bio do Insta não tem link nenhum — todo agendamento passa pelo direct
paciente que pesquisa "faceta Palmas" no Google chega em você ou no concorrente?`,
    followup_d3: `uma coisa que vejo em odonto premium
...
se fizer sentido depois, me chama`,
  ...
  1119: {
    ...
    abertura: `Vi que o "Site" no seu Google Maps é um link direto pro WhatsApp
paciente que pesquisa "dentista Palmas" cai num chat — sem contexto, sem prova, sem agenda
isso ainda funciona ou tá filtrando paciente cedo?`,
    followup_d3: `uma coisa que vejo aqui em Palmas
quem tem Maps 4.9 e site acaba ficando na frente de quem tem só WhatsApp. hoje tá assim com você?`,
    followup_d7: `vou parar por aqui pra não encher
se fizer sentido depois, me chama`,
  ...
  1115: {
    ...
    abertura: `Vi que tu atende lipedema em Palmas — nicho raro
paciente pesquisa MUITO antes de marcar e tem pouca opção qualificada
quem busca "nutricionista lipedema Palmas" hoje te acha ou cai em quem só faz dieta?`,
    followup_d3: `uma coisa que vejo em nutri
nicho específico (esportivo, lipedema) precisa de SEO local pra capturar busca — tu já reparou que tá perdendo paciente assim?`,
    followup_d7: `vou parar por aqui pra não encher
se fizer sentido depois, me chama`,
  ...
  1114: {
    ...
    abertura: `Vi que você tem podcast "Duas no Divã" + Junta Médica TO + 7k seguidores + 5★ no Maps
mas o link da bio (gamma.site) é layout genérico — paciente nova que pesquisa antes de marcar primeira sessão não vê nada do que você construiu
quanto dessa paciente nova perde porque o canal não comunica a autoridade?`,
    followup_d3: `uma coisa que vejo em psi com autoridade construída
...
se fizer sentido depois, me chama`,
  ...
  1117: {
    ...
    abertura: `Vi que tu é fisio domiciliar com Pós em Gerontologia CEULP, 5★/46 reviews, 365 posts (daily há 1 ano)
fisio domiciliar pra idoso, quem contrata é a FAMÍLIA — filha que vai contratar pra mãe pesquisa antes
quanto dessa filha tu acha que recua quando cai no sandwiche.me sem ver depoimentos?`,
    followup_d3: `uma coisa que vejo em fisio domiciliar gerontológica
...
se fizer sentido depois, me chama`,
  ...
  1131: {
    ...
    abertura: `Vi que você tem 294 reviews 5★ no Google em trabalhista — número absurdo, top 1 de Palmas pra quem pesquisa
mas cliente novo que vê review e quer saber mais cai num WhatsApp sem biografia, áreas, FAQ
quanto desse cliente novo perde no caminho?`,
    followup_d3: `uma coisa que vejo em advogado consolidado
Provimento 205/2021 da OAB libera LP informativa (sem preço, sem promessa) — você sabia que tinha isso?`,
    followup_d7: `vou parar por aqui pra não encher
se fizer sentido depois, me chama`,
  ...
  1125: {
    ...
    abertura: `Vi que você tem 190 reviews 5★ no Maps em endocrino — número absurdo, raríssimo no Brasil
mas o link da bio é um bit.ly — paciente que viu post sobre Mounjaro e pesquisa antes de marcar R$500 de consulta cai num "ABRIR WHATSAPP" sem biografia
quanto dessa paciente nova recua nesse momento?`,
    followup_d3: `uma coisa que vejo em endocrino com volume alto
...
se fizer sentido depois, me chama`,
  ...
  1122: {
    ...
    abertura: `Vi que você tem 15.900 seguidores no Insta — maior dentista do batch dental Palmas
mas o link da bio cai num wa.me direto, sem biografia, antes/depois categorizado, FAQ de preço
quanto dessa paciente de harmonização (R$3k+ de decisão) recua no momento do "olá!"?`,
    followup_d3: `uma coisa que vejo em dentista de harmonização premium
...
se fizer sentido depois, me chama`,
  ...
  1124: {
    ...
    abertura: `Vi que você atende colposcopia, tratamento HPV e histeroscopia em Palmas — subespecialização raríssima no Brasil
paciente diagnosticada com HPV pesquisa "tratamento HPV Palmas" no Google às 23h, cai num wa.me sem FAQ técnico
quanto dessa paciente premium perde antes do encaminhamento chegar?`,
    followup_d3: `uma coisa que vejo em ginecologista especialista
...
se fizer sentido depois, me chama`,
  ...
  1127: {
    ...
    abertura: `Vi que você é cirurgião ortopedista com cirurgia da mão e microcirurgia — subespecialização raríssima da região
você já investiu em ricardomendonca.com.br, mas o domínio raiz não tem site indexado — só link-in-bio
quanto desse paciente especialista que pesquisa "cirurgia da mão Palmas" perde por mês?`,
    followup_d3: `uma coisa que vejo em cirurgião com domínio dormente
...
se fizer sentido depois, me chama`,
  ...
  1133: {
    ...
    abertura: `Vi que tu opera home-office com terapias injetáveis e saúde funcional em Palmas
paciente nova que viu post sobre suplementação injetável vai pesquisar antes de marcar — ela vai até a TUA casa, decisão de confiança máxima
hoje quem busca isso te acha ou cai em quem tem site profissional?`,
    followup_d3: `uma coisa que vejo em terapia injetável home-office
paciente que vai até TUA casa pesquisa MUITO antes — Erlane tinha esse mesmo gargalo no DM antes da LP. tá rolando contigo?`,
    followup_d7: `vou parar por aqui pra não encher
se fizer sentido depois, me chama`,
  ...
  1135: {
    ...
    abertura: `Vi que tu trabalha com harmonização full face e glútea em Palmas — ticket R$1k-3k por protocolo
mas o link da bio cai num wa.me direto, sem biografia, CRBM em destaque, antes/depois, FAQ por protocolo
quanto dessa paciente premium recua nesse momento do "olá!"?`,
    followup_d3: `uma coisa que vejo em biomédica esteta premium
...
se fizer sentido depois, me chama`,
  ...
  1136: {
    ...
    abertura: `Vi que tu tem método "Beleza com Naturalidade" + parceria com Francone Bucar — ecossistema construído
...
quanto dessa paciente indicada recua no linktr.ee?`,
    followup_d3: `uma coisa que vejo em farmacêutica esteta com método autoral
linktr.ee cumpre o básico, mas teu método "Beleza com Naturalidade" merece vitrine própria. faz sentido pra ti?`,
    followup_d7: `vou parar por aqui pra não encher
se fizer sentido depois, me chama`,
  ...
  1137: {
    ...
    abertura: `Vi que tu trabalha com PEIM, soroterapia, botox, preenchimento e mais 3 áreas — operação premium consolidada
mas o linktr.ee lista 7 áreas sem hierarquia — paciente que vai gastar R$1k+ num PEIM cai sem ver método-âncora
se tu pudesse posicionar UM protocolo-âncora online, qual seria o que rende mais ROI por paciente?`,
    followup_d3: `uma coisa que vejo em estética injetável premium
1 paciente nova de R$1k+ paga 2x a LP — não é "site barato", é vitrine que qualifica ticket alto. faz sentido pra ti?`,
    followup_d7: `vou parar por aqui pra não encher
se fizer sentido depois, me chama`,
  ...
  1140: {
    ...
    abertura: `Vi que você tem método PROTAGONIZE + 16.5k seguidores + 99 reviews 5★ + site Vizzoone
mas toda dentista do Vizzoone tem site IGUAL ao seu, só com nome trocado — paciente que vai pagar R$3k em harmonização percebe que é "plataforma de dentista", não marca autoral
quanto dessa paciente premium recua nesse momento?`,
    followup_d3: `uma coisa que vejo em dentista com método autoral
...
se fizer sentido depois, me chama`,
  ...
  1141: {
    ...
    abertura: `Vi que vocês têm 45.100 seguidores Insta verified + plano semanal de marmita fit em Palmas
mas o link da bio é Canva site — cliente que quer plano semanal manda mensagem TODA SEGUNDA pra confirmar e pix
quanto cliente desiste nessa fricção semanal?`,
    followup_d3: `uma coisa que vejo em marmita fit com plano semanal
1 cliente de R$300/sem = R$14.400/ano que tu não captura sem checkout recorrente. faz sentido pra ti?`,
    followup_d7: `vou parar por aqui pra não encher
se fizer sentido depois, me chama`,
  ...
  1142: {
    ...
    abertura: `Vi que vocês têm 855 reviews 5★ no Maps + cobertura Palmas/Porto/Paraíso/Gurupi — referência regional de suplemento no Tocantins
mas o link da bio é linktr.ee — cliente de Gurupi que viu post sobre creatina não tem cálculo de frete nem catálogo navegável
quanto desse cliente regional vocês perdem por não ter checkout pra fora de Palmas?`,
    followup_d3: `uma coisa que vejo em loja com cobertura regional
...
se fizer sentido depois, me chama`,
  ...
  1143: {
    ...
    abertura: `Vi que vocês têm 20.100 seguidores + Lives semanais como destaque do perfil
mas cliente que assistiu Live ontem e não comprou na hora hoje volta, vê o produto e precisa mandar DM (30 mensagens)
quantas desistem antes de fechar?`,
    followup_d3: `uma coisa que vejo em loja com Live ativa
"A Live vende, o Shopify fecha" — quem viu Live ontem fecha checkout 24/7 sem 30 mensagens cruzadas. faz sentido pra vocês?`,
  ...
  1144: {
    ...
    abertura: `Vi que vocês são únicos em Palmas a vender "do 34 ao 60" — mulher real
mas o link da bio é bio.site — cliente 48+ que pesquisa "DeLótus tamanho 48" antes de mandar DM cai num link sem filtro por tamanho, sem confirmação
quanto dessa cliente 44+ recua nesse momento de incerteza?`,
    followup_d3: `uma coisa que vejo em moda inclusiva
...
se fizer sentido depois, me chama`,
  ...
  1146: {
    ...
    abertura: `Vi que vocês têm assistência autorizada Movement e Matrix + ticket R$200-2.500 por equipamento
mas o link da bio é abre.ai — cliente que vai gastar R$1.500 num banco musculação não vê ficha técnica, dimensões, peso, garantia
quanto desse cliente recua antes de ligar?`,
    followup_d3: `uma coisa que vejo em loja de equipamento ticket alto
...
se fizer sentido depois, me chama`,
  ...
  1150: {
    ...
    abertura: `Vi que tu tem 1.433 posts em 3.9k seguidores + CREF GO-TO + nicho CrossFit/Atleta Híbrido em Palmas
mas zero link externo — cada post chega em 500-1000 pessoas, e quem fica interessado some na fricção do "vou mandar DM depois"
quantos alunos por ano tu acha que perde por inércia?`,
    followup_d3: `uma coisa que vejo em personal técnico
1.433 posts sem captura = 100 alunos perdidos por ano em quem viu, ficou interessado e esqueceu. faz sentido pra ti?`,
    followup_d7: `vou parar por aqui pra não encher
se fizer sentido depois, me chama`,
  ...
  1149: {
    ...
    abertura: `Vi que tu tem 1.143 posts + vínculo com Integral Clinic (4.8★/731 reviews) — consistência rara em nutri Palmas
mas o link da bio é msha.ke — paciente nova que viu post sobre flexibilidade metabólica cai sem teu rosto, sem Integral Clinic em destaque
quanto dessa paciente nova recua nesse momento?`,
    followup_d3: `uma coisa que vejo em nutri funcional
...
se fizer sentido depois, me chama`,
  ...
  1151: {
    ...
    abertura: `Vi que tu tem Insta verified (raríssimo em personal Palmas) + Medicina do Exercício como especialização
mas o link da bio é eksy.me — aluno premium que paga R$500+/mês pesquisa MUITO antes de fechar e não vê biografia clínica
quanto dele recua no eksy.me sem ver tua especialização?`,
    followup_d3: `uma coisa que vejo em personal verified premium
...
se fizer sentido depois, me chama`,
  ...
  1152: {
    ...
    abertura: `Vi que tu tem +200 alunos transformados + posicionamento "teamJW" como comunidade
mas hoje "team" só vive como hashtag — não tem área de membros, ranking de transformações, treinos por nível
topa virar teamJW em produto recorrente real (assinatura mensal com membership area)?`,
    followup_d3: `uma coisa que vejo em personal com tese forte
"team" como hashtag não vira receita — membership area transforma em assinatura R$10k/mês recorrente. faz sentido pra ti?`,
    followup_d7: `vou parar por aqui pra não encher
se fizer sentido depois, me chama`,
  ...
  1153: {
    ...
    abertura: `Vi que tu tem CREF GO-TO + bio explícita Palmas + posicionamento técnico ("melhor versão")
mas zero link externo — tu tá num momento ÚNICO de crescimento, e cada novo seguidor vê post e esquece
cada novo seguidor cai num funil que captura, ou só vê e some?`,
    followup_d3: `uma coisa que vejo em personal entry-level
...
se fizer sentido depois, me chama`,
  ...
  1155: {
    ...
    abertura: `Vi que tu é Atleta Fisiculturista + Personal + Consultoria Online + CREF G/TO em Palmas
mas o link da bio é wa.me direto — 354 posts + destaque "Relatos Online" cheio sem captura
quanto aluno novo perde porque a prova social não tá em galeria scrollable acessível?`,
    followup_d3: `uma coisa que vejo em atleta-personal premium
...
se fizer sentido depois, me chama`,
  ...
  1156: {
    ...
    abertura: `Vi que tu tem CREF GO/TO próprio + bio explícita "Personal Trainer e Consultoria Online"
mas o link da bio redireciona pra @tebasconceito01 — aluno que quer TUA consultoria cai no perfil do parceiro
quanto aluno tu acha que recua nesse momento de "ele queria TI, não a academia"?`,
    followup_d3: `uma coisa que vejo em personal com marca própria
...
se fizer sentido depois, me chama`,
  ...
  1157: {
    ...
    abertura: `Vi que você é Médico do Esporte CRM-TO 3949 + RQE com nicho duplo (atletas + transplante capilar)
mas o link da bio é bit.ly — paciente de transplante capilar vai gastar R$10-15k e cai num link sem biografia, casos, FAQ
quanto desse paciente premium recua antes mesmo de marcar?`,
    followup_d3: `uma coisa que vejo em médico do esporte com nicho duplo
...
se fizer sentido depois, me chama`,
  ...
  1158: {
    ...
    abertura: `Vi que você é urologista CRM-TO 4856 com Cirurgia Robótica + Uro-oncologia + 1.000+ pacientes operados
mas o link da bio é linktr.ee — paciente de cirurgia robótica (R$15-25k) cai sem ver catálogo cirúrgico, RQE, casos
quanto desse paciente premium recua nesse momento?`,
    followup_d3: `uma coisa que vejo em cirurgião urológico premium
...
se fizer sentido depois, me chama`,
  ...
  1159: {
    ...
    abertura: `Vi que sua bio começa com "Empreendedor" (raro em médico) + Membro SBU + Cirurgia Robótica + Vasectomia
mas o link da bio é linktr.ee — médico empreendedor com mindset comercial deveria ter funil de captura, não link genérico
cada novo seguidor seu cai num funil que captura ou só vê e some?`,
    followup_d3: `uma coisa que vejo em urologista empreendedor
...
se fizer sentido depois, me chama`,
  ...
  1160: {
    ...
    abertura: `Vi que você é Professor Afya & UNIRG + reumatologista CRM-TO 3873 com RQE 1688
mas o link da bio é wa.me direto — professor universitário de medicina perdendo paciente novo num "Olá!" sem biografia, sem teus 5 temas
quanto paciente recua antes mesmo de saber do papel acadêmico?`,
    followup_d3: `uma coisa que vejo em médico professor
...
se fizer sentido depois, me chama`,
  ...
  1161: {
    ...
    abertura: `Vi que você é Ex-Presidente SBC-TO 2024-2025 + cardiologista CRM-TO 4081 — autoridade máxima do estado
mas o link da bio é linktr.ee — paciente classe A/B que pesquisa antes de marcar consulta R$500-700 cai num linktree genérico, sem selo Ex-Presidente SBC, sem canal Particular vs Convênios
quanto desse paciente premium percebe a desproporção e recua?`,
    followup_d3: `uma coisa que vejo em médico de autoridade máxima
...
se fizer sentido depois, me chama`,
  ...
  1162: {
    ...
    abertura: `Vi que você tem 2.342 posts + RQE TRIPLO (Reumatologia + Clínica + Medicina do Trabalho) — recorde editorial
mas o link da bio é linktr.ee — empresa que precisa de PCMSO/PPRA cai num link misturado com fibromialgia e lupus
quanto receita B2B você perde por não separar Medicina do Trabalho do funil reumato?`,
    followup_d3: `uma coisa que vejo em médico com RQE triplo
linktree linear não separa B2C (paciente) de B2B (empresa) — LP estruturada vira 2 funis de receita simultâneos. faz sentido pra você?`,
    followup_d7: `vou parar por aqui pra não encher
se fizer sentido depois, me chama`,
