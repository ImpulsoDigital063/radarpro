    ...
    messages: [
      {
        ...
        content: [
          ...
          '· NÃO temos WhatsApp automático nem nota fiscal. NÃO MINTA — responda honesto e',
          '  use a honestidade como arma ("se isso é essencial pra você, eu paro por aqui").',
          ...
          '  "se_perguntar_whatsapp_automatico": "NÃO TEMOS. Responda honesto e não perca a venda.",',
